...
-- 2) Retrieve the orderDate, requiredDate, and status of orders that are currently
--    'In Process' from the orders table. Sort the results in descending order of orderDate.
SELECT
  orderDate,
  requiredDate,
  status
